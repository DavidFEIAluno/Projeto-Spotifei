 ...
 *
 * @author ivald
 * Acesso ao banco de dados dos Usuarios e devolve 
 * a informação para os controllers que requisitam os usuarios, basicamente todos, mas no geral 
 * o Login e Cadastro que mais a utilizam.
 */
    ...
    public boolean cadastrarUsuario(Usuario usuario) {
        ...
        try (Connection conn = Conexao.getConexao();
            ...
            if (affectedRows > 0) {
                ...
                Conexao.commit(); //Commit é muito importante... sempre esqueço.
                return true;
    }
        } catch (SQLException e) {
